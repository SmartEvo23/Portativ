...
class UserController extends GetxController {
  ...
  Future<void> saveUserRecord({UserModel? user, UserCredential? userCredentials}) async {
    try {
      ...
      TLoaders.warningSnackBar(
        title: 'Datele nu s-au salvat',
        message: 'A apărut o eroare la salvarea informațiilor tale. Poți re-salva datele în Profil.',
      );
    }
  }
  ...
  uploadUserProfilePicture() async {
    try {
      ...
      if (image != null) {
        ...
        TLoaders.successSnackBar(title: 'Felicitări', message: 'Imaginea ta de profil a fost actualizată!');
      }
    } catch (e) {
      imageUploading.value = false;
      TLoaders.errorSnackBar(title: 'Hoppa!', message: 'Ceva nu a funcționat: $e');
    }
  }
  ...
  void deleteAccountWarningPopup() {
    Get.defaultDialog(
      ...
      title: 'Ștergere cont',
      middleText:
          'Sigur îți dorești să îți ștergi contul definitiv? Această acțiune nu este reversibilă și toate datele tale vor fi șterse definitiv.',
      confirm: ElevatedButton(
        onPressed: () async => deleteUserAccount(),
        style: ElevatedButton.styleFrom(backgroundColor: Colors.red, side: const BorderSide(color: Colors.red)),
        child: const Padding(padding: EdgeInsets.symmetric(horizontal: TSizes.lg), child: Text('Ștergere')),
      ),
  ...
  void deleteUserAccount() async {
    try {
      TFullScreenLoader.openLoadingDialog('Procesare', TImages.docerAnimation);
      ...
      TFullScreenLoader.stopLoading();
      TLoaders.warningSnackBar(title: 'Hoppa!', message: e.toString());
    }
  }
  ...
  logout() {
    try {
      Get.defaultDialog(
        contentPadding: const EdgeInsets.all(TSizes.md),
        title: 'Delogare',
        middleText: 'Ești sigur că vrei să ieși?',
        confirm: ElevatedButton(
          child: const Padding(
            padding: EdgeInsets.symmetric(horizontal: TSizes.lg),
            child: Text('Confirmare'),
          ),
          onPressed: () async {
            onClose();
      ...
      TLoaders.errorSnackBar(title: 'Hoppa!', message: e.toString());
    }
  }
}
