    ...
    return PopScope(
      ...
      child: DefaultTabController(
        ...
        child: Scaffold(
          ...
          appBar: TAppBar(
            title: Text('Totul despre muzică', style: Theme.of(context).textTheme.headlineMedium),
                  ...
                  flexibleSpace: Padding(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        const TSearchContainer(text: 'Căutare', showBorder: true, showBackground: false, padding: EdgeInsets.zero),
